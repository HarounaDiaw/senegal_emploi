...
public class CandidatTestSamples {
    ...
    public static Candidat getCandidatSample1() {
        return new Candidat().id(1L).cv("cv1").telephone("telephone1").adresse("adresse1").photo("photo1");
    }

    public static Candidat getCandidatSample2() {
        return new Candidat().id(2L).cv("cv2").telephone("telephone2").adresse("adresse2").photo("photo2");
    }
