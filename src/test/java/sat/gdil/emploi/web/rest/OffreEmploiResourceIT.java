...
class OffreEmploiResourceIT {
    ...
    private static final String DEFAULT_AFFICHE = "AAAAAAAAAA";
    private static final String UPDATED_AFFICHE = "BBBBBBBBBB";
    ...
    void getAllOffreEmplois() throws Exception {
        ...
        restOffreEmploiMockMvc
            ...
            .andExpect(jsonPath("$.[*].affiche").value(hasItem(DEFAULT_AFFICHE)));
    }
    ...
    void getOffreEmploi() throws Exception {
        ...
        restOffreEmploiMockMvc
            ...
            .andExpect(jsonPath("$.affiche").value(DEFAULT_AFFICHE));
    }
