...
import static sat.gdil.emploi.web.rest.TestUtil.createUpdateProxyForBean;
...
import sat.gdil.emploi.IntegrationTest;
...
class CandidatResourceIT {
    ...
    public static Candidat createEntity() {
        return new Candidat().cv(DEFAULT_CV).telephone(DEFAULT_TELEPHONE).adresse(DEFAULT_ADRESSE).sexe(DEFAULT_SEXE).photo(DEFAULT_PHOTO);
    }
    ...
    public static Candidat createUpdatedEntity() {
        return new Candidat().cv(UPDATED_CV).telephone(UPDATED_TELEPHONE).adresse(UPDATED_ADRESSE).sexe(UPDATED_SEXE).photo(UPDATED_PHOTO);
    }
    ...
    void putExistingCandidat() throws Exception {
        ...
        updatedCandidat.cv(UPDATED_CV).telephone(UPDATED_TELEPHONE).adresse(UPDATED_ADRESSE).sexe(UPDATED_SEXE).photo(UPDATED_PHOTO);
    ...
    void partialUpdateCandidatWithPatch() throws Exception {
        ...
        partialUpdatedCandidat.photo(UPDATED_PHOTO);
    ...
    void fullUpdateCandidatWithPatch() throws Exception {
        ...
        partialUpdatedCandidat.cv(UPDATED_CV).telephone(UPDATED_TELEPHONE).adresse(UPDATED_ADRESSE).sexe(UPDATED_SEXE).photo(UPDATED_PHOTO);
