...
export class OffreEmploiComponent implements OnInit {
      ...
      .pipe(
        ...
        tap(() => {
          if (this.offreEmplois().length === 0) {
            ...
            this.offreEmplois.set(this.refineData(this.offreEmplois()));
          }
        }),
      )
      .subscribe();
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.offreEmplois.set(this.refineData(dataFromBody));
  }

  protected refineData(data: IOffreEmploi[]): IOffreEmploi[] {
