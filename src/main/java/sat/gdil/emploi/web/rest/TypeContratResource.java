...
/**
 * REST controller for managing {@link sat.gdil.emploi.domain.TypeContrat}.
 */
@RestController
...
public class TypeContratResource {
    ...
    public ResponseEntity<TypeContratDTO> createTypeContrat(@Valid @RequestBody TypeContratDTO typeContratDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/type-contrats/" + typeContratDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, typeContratDTO.getId().toString()))
            .body(typeContratDTO);
    }
    ...
    public ResponseEntity<TypeContratDTO> updateTypeContrat(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, typeContratDTO.getId().toString()))
            .body(typeContratDTO);
    }
    ...
    public ResponseEntity<TypeContratDTO> partialUpdateTypeContrat(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, typeContratDTO.getId().toString())
        );
    }
