...
/**
 * REST controller for managing {@link sat.gdil.emploi.domain.Recruteur}.
 */
@RestController
...
public class RecruteurResource {
    ...
    public ResponseEntity<RecruteurDTO> createRecruteur(@RequestBody RecruteurDTO recruteurDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/recruteurs/" + recruteurDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, recruteurDTO.getId().toString()))
            .body(recruteurDTO);
    }
    ...
    public ResponseEntity<RecruteurDTO> updateRecruteur(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, recruteurDTO.getId().toString()))
            .body(recruteurDTO);
    }
    ...
    public ResponseEntity<RecruteurDTO> partialUpdateRecruteur(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, recruteurDTO.getId().toString())
        );
    }
