...
/**
 * REST controller for managing {@link sat.gdil.emploi.domain.Poste}.
 */
@RestController
...
public class PosteResource {
    ...
    public ResponseEntity<PosteDTO> createPoste(@Valid @RequestBody PosteDTO posteDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/postes/" + posteDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, posteDTO.getId().toString()))
            .body(posteDTO);
    }
    ...
    public ResponseEntity<PosteDTO> partialUpdatePoste(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, posteDTO.getId().toString())
        );
    }
