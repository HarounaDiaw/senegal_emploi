...
/**
 * REST controller for managing {@link sat.gdil.emploi.domain.OffreEmploi}.
 */
@RestController
...
public class OffreEmploiResource {
    ...
    public ResponseEntity<OffreEmploiDTO> createOffreEmploi(@Valid @RequestBody OffreEmploiDTO offreEmploiDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/offre-emplois/" + offreEmploiDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, offreEmploiDTO.getId().toString()))
            .body(offreEmploiDTO);
    }
    ...
    public ResponseEntity<OffreEmploiDTO> updateOffreEmploi(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, offreEmploiDTO.getId().toString()))
            .body(offreEmploiDTO);
    }
    ...
    public ResponseEntity<OffreEmploiDTO> partialUpdateOffreEmploi(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, offreEmploiDTO.getId().toString())
        );
    }
    ...
    public List<OffreEmploiDTO> getAllOffreEmplois() {
        LOG.debug("REST request to get all OffreEmplois");
