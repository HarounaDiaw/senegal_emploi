...
/**
 * REST controller for managing {@link sat.gdil.emploi.domain.Candidat}.
 */
@RestController
...
public class CandidatResource {
    ...
    public ResponseEntity<CandidatDTO> createCandidat(@RequestBody CandidatDTO candidatDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/candidats/" + candidatDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, candidatDTO.getId().toString()))
            .body(candidatDTO);
    }
    ...
    public ResponseEntity<CandidatDTO> updateCandidat(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, candidatDTO.getId().toString()))
            .body(candidatDTO);
    }
    ...
    public ResponseEntity<CandidatDTO> partialUpdateCandidat(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, candidatDTO.getId().toString())
        );
    }
