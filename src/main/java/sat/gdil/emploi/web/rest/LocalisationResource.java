...
/**
 * REST controller for managing {@link sat.gdil.emploi.domain.Localisation}.
 */
@RestController
...
public class LocalisationResource {
    ...
    public ResponseEntity<LocalisationDTO> createLocalisation(@Valid @RequestBody LocalisationDTO localisationDTO)
        ...
        return ResponseEntity.created(new URI("/api/localisations/" + localisationDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, localisationDTO.getId().toString()))
    ...
    public ResponseEntity<LocalisationDTO> updateLocalisation(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, localisationDTO.getId().toString()))
            .body(localisationDTO);
    }
    ...
    public ResponseEntity<LocalisationDTO> partialUpdateLocalisation(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, localisationDTO.getId().toString())
        );
    }
